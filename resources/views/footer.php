            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
                        ...
                        <?php foreach($typesFooter as $typeFooter) : ?>
                            <li> <a href="<?= route('type', ['id' => $typeFooter->id]) ?>" class="text-muted"><?= $typeFooter->name ?></a></li>
                        <?php endforeach; ?>
                        </ul>
                    </div>
                    <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
                        ...
                        <ul class="list-unstyled">
                            <?php foreach($brandsFooter as $brandFooter): ?>
                            <li> <a href="<?= route('brand', ['id' => $brandFooter->id]) ?>" class="text-muted"><?= $brandFooter->name ?></a></li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
                    <div class="col-lg-4">
